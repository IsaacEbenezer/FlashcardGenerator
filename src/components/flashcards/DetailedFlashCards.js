          ...
          <div key={index}>
            ...
            <div className="flex flex-col items-center justify-center lg:items-start my-11 lg:flex-row lg:justify-between sm:items-center sm:justify-center sm:flex-col mb-14">
              ...
              <div className="w-full lg:w-2/4 sm:w-full">
                {elem.state.map((element, index) => {
                  return cardHandler === index ? (
                    <div
                      key={index}
                      className="w-full flex flex-col justify-between px-5 py-9 sm:flex-col lg:flex-row bg-white rounded-md shadow-lg"
                    >
                      <div className="w-2/4 max-h-96 lg:w-2/4 lg:max-h-96  sm:w-full sm:max-w-lg">
                        <img
                          className="inline-block w-full"
                          src="https://images.pexels.com/photos/5926389/pexels-photo-5926389.jpeg?auto=compress&cs=tinysrgb&w=600 "
                          alt="carousel_img"
                        />
                      </div>
                      <div className="w-full text-justify sm:mt-6 lg:mt-0 sm:w-full lg:w-2/5">
                        <p>{element.defination}</p>
                      </div>
                    </div>
                  ) : null;
                })}
...
export default DetailedFlashCards;
